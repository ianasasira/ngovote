...
<div>
	...
	<a href="polls.php"><i class="fas fa-sign-out-alt"></i>Management</a>&nbsp&nbsp&nbsp
		...
		<div class="content">
			<h2>Admin Page</h2>
			<p>Welcome back, <?php echo $_SESSION['user_id_admin'];?>! The Polls for the students are presented as below.</p>
...
echo "<b>HEAD BOY</b><br><br>";
					...
					echo "<b>SENIOR LITURGY</b><br><br>";
																		//seniorliturgy
																		$query = "SELECT `username`,`votes` FROM `seniorliturgy`";
																		$query_run = mysqli_query($conn,$query);
												while ($fetch=mysqli_fetch_assoc($query_run)) {
													$username = $fetch['username'];
													$votes = $fetch['votes'];
						...
						echo "<b>JUNIOR LITURGY</b><br><br>";
																		//juniorliturgy
																		$query = "SELECT `username`,`votes` FROM `juniorliturgy`";
																		$query_run = mysqli_query($conn,$query);
												while ($fetch=mysqli_fetch_assoc($query_run)) {
													$username = $fetch['username'];
													$votes = $fetch['votes'];
