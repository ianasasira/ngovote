...
<p> Please vote your candidates by clicking the vote button next to the candidate<b> remember you only vote once and this is irreversible.</b> </p>
			 ...
			 <form action="" method="post">
				 	 ...
				 	 <strong>SENIOR mckee</strong> <br>
				 	 <br>

				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `seniormckee` WHERE `id`=1";
				 	 	...
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			...
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C172' name='C172' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `seniormckee` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C173' name='C173' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `seniormckee` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C174' name='C174' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `seniormckee` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C175' name='C175' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `seniormckee` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C176' name='C176' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				...
				<br><br> 	 <strong>JUNIOR mckee</strong> <br>
				 	 <br>


				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `juniormckee` WHERE `id`=1";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			$fetch = mysqli_fetch_assoc($query_run);
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C177' name='C177' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `juniormckee` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C178' name='C178' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `juniormckee` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C179' name='C179' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `juniormckee` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C180' name='C180' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `juniormckee` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C181' name='C181' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
