...
// here we are going to declare an if statement tp=o check the hostel variables in the databse then we shall either present hostel or polls or none
...
<p> Please vote your candidates by clicking the vote button next to the candidate<b> remember you only vote once and this is irreversible.</b> </p>
			 ...
			 <form action="" method="post">
		 			 ...
		 			 <strong>SENIOR DOYLE</strong> <br>
		 			 <br>

		 			 		<?php
		 			 		//candidate 1
		 			 	$query="SELECT `username` FROM `seniordoyle` WHERE `id`=1";
		 			 	...
		 			 	if ($query_run) {
		 			 		if (mysqli_num_rows($query_run)==1) {
		 			 			...
		 			 			$name = $fetch['username'];
		 			 			echo '&nbsp'.'&nbsp'.$name;
		 			 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C132' name='C132' value=$name class='btn btn-primary'></input>" ;
		 			 		}else {
		 			 			echo " N/A";
		 			 		}
		 			 	}else {
		 			 	...
		 			 	//candidate 2
		 			 	$query="SELECT `username` FROM `seniordoyle` WHERE `id`=2";
		 			 	$query_run = mysqli_query($conn,$query);
		 			 	if ($query_run) {
		 			 	if (mysqli_num_rows($query_run)==1) {
		 			 		$fetch = mysqli_fetch_assoc($query_run);
		 			 		$name = $fetch['username'];
		 			 		echo '&nbsp'.'&nbsp'.$name;
		 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C133' name='C133' value=$name class='btn btn-primary' id = 'btn'></input>" ;
		 			 	}else {
		 			 		echo " N/A";
		 			 	}
		 			 	}else {
		 			 	...
		 			 	//candidate 3
		 			 	$query="SELECT `username` FROM `seniordoyle` WHERE `id`=3";
		 			 	$query_run = mysqli_query($conn,$query);
		 			 	if ($query_run) {
		 			 	if (mysqli_num_rows($query_run)==1) {
		 			 		$fetch = mysqli_fetch_assoc($query_run);
		 			 		$name = $fetch['username'];
		 			 		echo '&nbsp'.'&nbsp'.$name;
		 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C134' name='C134' value=$name class='btn btn-primary'></input>" ;
		 			 	}else {
		 			 		echo " N/A";
		 			 	}
		 			 	}else {
		 			 	...
		 			 	//candidate 4
		 			 	$query="SELECT `username` FROM `seniordoyle` WHERE `id`=4";
		 			 	$query_run = mysqli_query($conn,$query);
		 			 	if ($query_run) {
		 			 	if (mysqli_num_rows($query_run)==1) {
		 			 		$fetch = mysqli_fetch_assoc($query_run);
		 			 		$name = $fetch['username'];
		 			 		echo '&nbsp'.'&nbsp'.$name;
		 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C135' name='C135' value=$name class='btn btn-primary'></input>" ;
		 			 	}else {
		 			 		echo " N/A";
		 			 	}
		 			 	}else {
		 			 	...
		 			 	//candidate 5
		 			 	$query="SELECT `username` FROM `seniordoyle` WHERE `id`=5";
		 			 	$query_run = mysqli_query($conn,$query);
		 			 	if ($query_run) {
		 			 	if (mysqli_num_rows($query_run)==1) {
		 			 		$fetch = mysqli_fetch_assoc($query_run);
		 			 		$name = $fetch['username'];
		 			 		echo '&nbsp'.'&nbsp'.$name;
		 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C136' name='C136' value=$name class='btn btn-primary'></input>" ;
		 			 	}else {
		 			 		echo " N/A";
		 			 	}
		 			 	}else {
		 			 		echo " N/A";
		 			 		  ...
		 			 		  ?>
										 			...
										 			<br><br> <strong>JUNIOR DOYLE</strong> <br>
										 			 <br>

										 			 		<?php
										 			 		//candidate 1
										 			 	$query="SELECT `username` FROM `juniordoyle` WHERE `id`=1";
										 			 	$query_run = mysqli_query($conn,$query);
										 			 	if ($query_run) {
										 			 		if (mysqli_num_rows($query_run)==1) {
										 			 			$fetch = mysqli_fetch_assoc($query_run);
										 			 			$name = $fetch['username'];
										 			 			echo '&nbsp'.'&nbsp'.$name;
										 			 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C137' name='C137' value=$name class='btn btn-primary'></input>" ;
										 			 		}else {
										 			 			echo " N/A";
										 			 		}
										 			 	}else {
										 			 	...
										 			 	//candidate 2
										 			 	$query="SELECT `username` FROM `juniordoyle` WHERE `id`=2";
										 			 	$query_run = mysqli_query($conn,$query);
										 			 	if ($query_run) {
										 			 	if (mysqli_num_rows($query_run)==1) {
										 			 		$fetch = mysqli_fetch_assoc($query_run);
										 			 		$name = $fetch['username'];
										 			 		echo '&nbsp'.'&nbsp'.$name;
										 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C138' name='C138' value=$name class='btn btn-primary' id = 'btn'></input>" ;
										 			 	}else {
										 			 		echo " N/A";
										 			 	}
										 			 	}else {
										 			 	...
										 			 	//candidate 3
										 			 	$query="SELECT `username` FROM `juniordoyle` WHERE `id`=3";
										 			 	$query_run = mysqli_query($conn,$query);
										 			 	if ($query_run) {
										 			 	if (mysqli_num_rows($query_run)==1) {
										 			 		$fetch = mysqli_fetch_assoc($query_run);
										 			 		$name = $fetch['username'];
										 			 		echo '&nbsp'.'&nbsp'.$name;
										 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C139' name='C139' value=$name class='btn btn-primary'></input>" ;
										 			 	}else {
										 			 		echo " N/A";
										 			 	}
										 			 	}else {
										 			 	...
										 			 	//candidate 4
										 			 	$query="SELECT `username` FROM `juniordoyle` WHERE `id`=4";
										 			 	$query_run = mysqli_query($conn,$query);
										 			 	if ($query_run) {
										 			 	if (mysqli_num_rows($query_run)==1) {
										 			 		$fetch = mysqli_fetch_assoc($query_run);
										 			 		$name = $fetch['username'];
										 			 		echo '&nbsp'.'&nbsp'.$name;
										 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C140' name='C140' value=$name class='btn btn-primary'></input>" ;
										 			 	}else {
										 			 		echo " N/A";
										 			 	}
										 			 	}else {
										 			 	...
										 			 	//candidate 5
										 			 	$query="SELECT `username` FROM `juniordoyle` WHERE `id`=5";
										 			 	$query_run = mysqli_query($conn,$query);
										 			 	if ($query_run) {
										 			 	if (mysqli_num_rows($query_run)==1) {
										 			 		$fetch = mysqli_fetch_assoc($query_run);
										 			 		$name = $fetch['username'];
										 			 		echo '&nbsp'.'&nbsp'.$name;
										 			 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C141' name='C141' value=$name class='btn btn-primary'></input>" ;
										 			 	}else {
										 			 		echo " N/A";
										 			 	}
										 			 	}else {
