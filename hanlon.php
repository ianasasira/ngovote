...
<p> Please vote your candidates by clicking the vote button next to the candidate<b> remember you only vote once and this is irreversible.</b> </p>
			 ...
			 <form action="" method="post">
				 	 ...
				 	 <strong>SENIOR HANLON</strong> <br>
				 	 <br>

				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `seniorhanlon` WHERE `id`=1";
				 	 	...
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			...
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C142' name='C142' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `seniorhanlon` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C143' name='C143' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `seniorhanlon` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C144' name='C144' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `seniorhanlon` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C145' name='C145' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `seniorhanlon` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C146' name='C146' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
			...
			<br><br>	 	 <strong>JUNIOR HANLON</strong> <br>
				 	 <br>


				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `juniorhanlon` WHERE `id`=1";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			$fetch = mysqli_fetch_assoc($query_run);
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C147' name='C147' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `juniorhanlon` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C148' name='C148' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `juniorhanlon` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C149' name='C149' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `juniorhanlon` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C150' name='C150' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `juniorhanlon` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C151' name='C151' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
