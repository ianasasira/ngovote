...
<p> Please vote your candidates by clicking the vote button next to the candidate<b> remember you only vote once and this is irreversible.</b> </p>
			 ...
			 <form action="" method="post">
				 	 ...
				 	 <strong>SENIOR BILLINGTON</strong> <br>
				 	 <br>

				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `seniorbillington` WHERE `id`=1";
				 	 	...
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			...
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C103'name='C103' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `seniorbillington` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C104'name='C104' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `seniorbillington` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C105'name='C105' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `seniorbillington` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C106'name='C106' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `seniorbillington` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C107'name='C107' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
			...
			<br><br>	 	 <strong>JUNIOR BILLINGTON</strong> <br>
				 	 <br>


				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `juniorbillington` WHERE `id`=1";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			$fetch = mysqli_fetch_assoc($query_run);
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C108'name='C108' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `juniorbillington` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C109'name='C109' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `juniorbillington` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C110a'name='C110a' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `juniorbillington` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C110'name='C110' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `juniorbillington` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C111'name='C111' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
