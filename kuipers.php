...
<p> Please vote your candidates by clicking the vote button next to the candidate<b> remember you only vote once and this is irreversible.</b> </p>
			 ...
			 <form action="" method="post">
				 	 ...
				 	 <strong>SENIOR KUIPERS</strong> <br>
				 	 <br>

				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `seniorkuipers` WHERE `id`=1";
				 	 	...
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			...
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C162' name='C162' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `seniorkuipers` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C163' name='C163' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `seniorkuipers` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C164' name='C164' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `seniorkuipers` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C165' name='C165' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `seniorkuipers` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C166' name='C166' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
			...
			<br><br>	 	 <strong>JUNIOR KUIPERS</strong> <br>
				 	 <br>


				 	 		<?php
				 	 		//candidate 1
				 	 	$query="SELECT `username` FROM `juniorkuipers` WHERE `id`=1";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 		if (mysqli_num_rows($query_run)==1) {
				 	 			$fetch = mysqli_fetch_assoc($query_run);
				 	 			$name = $fetch['username'];
				 	 			echo '&nbsp'.'&nbsp'.$name;
				 	 			echo '&nbsp'.'&nbsp'."<input type='submit' id='C167' name='C167' value=$name class='btn btn-primary'></input>" ;
				 	 		}else {
				 	 			echo " N/A";
				 	 		}
				 	 	}else {
				 	 	...
				 	 	//candidate 2
				 	 	$query="SELECT `username` FROM `juniorkuipers` WHERE `id`=2";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C168' name='C168' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 3
				 	 	$query="SELECT `username` FROM `juniorkuipers` WHERE `id`=3";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C169' name='C169' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 4
				 	 	$query="SELECT `username` FROM `juniorkuipers` WHERE `id`=4";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C170' name='C170' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
				 	 	...
				 	 	//candidate 5
				 	 	$query="SELECT `username` FROM `juniorkuipers` WHERE `id`=5";
				 	 	$query_run = mysqli_query($conn,$query);
				 	 	if ($query_run) {
				 	 	if (mysqli_num_rows($query_run)==1) {
				 	 		$fetch = mysqli_fetch_assoc($query_run);
				 	 		$name = $fetch['username'];
				 	 		echo '&nbsp'.'&nbsp'.$name;
				 	 		echo '&nbsp'.'&nbsp'."<input type='submit' id='C171' name='C171' value=$name class='btn btn-primary'></input>" ;
				 	 	}else {
				 	 		echo " N/A";
				 	 	}
				 	 	}else {
